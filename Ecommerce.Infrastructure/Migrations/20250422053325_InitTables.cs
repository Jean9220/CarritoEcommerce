    ...
    public partial class InitTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppliedCartsCartId = table.Column<int>(type: "int", nullable: false),
                    AppliedDiscountsDiscountId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartDiscounts", x => new { x.AppliedCartsCartId, x.AppliedDiscountsDiscountId });
                    table.ForeignKey(
                        name: "FK_CartDiscounts_Carts_AppliedCartsCartId",
                        column: x => x.AppliedCartsCartId,
                        principalTable: "Carts",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartDiscounts_Discounts_AppliedDiscountsDiscountId",
                        column: x => x.AppliedDiscountsDiscountId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartDiscounts_AppliedDiscountsDiscountId",
                table: "CartDiscounts",
                column: "AppliedDiscountsDiscountId");
